...
| **Moments editor** | **Libero** (live **v255** — copertina blur fill) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v220-cover-blur**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
