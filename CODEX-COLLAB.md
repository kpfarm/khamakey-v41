...
| **Admin / Officina Moments** | **Libero** (live **v199** — PNG schede + PNG 2 misure) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js`, `moments-admin.css` — coordinarsi se stesso pannello |
