...
| **Moments editor** | **Libero** (live **v235** — hardening salvataggi) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v197-signature-voi**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
