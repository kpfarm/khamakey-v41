...
| **Moments editor** | **Lock 2026-09-17** restyling grafico Dopo (pack unico, **non** produzione finché preview ok) + **ticket invitato upload/salva v282** (stesso pack, niente deploy produzione) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v233-countdown-fit**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
