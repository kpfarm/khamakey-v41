...
| **Moments editor** | **Libero** (live **v236** — pre-lancio salva) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v199-upload-quota-safe**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
