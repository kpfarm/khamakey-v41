...
| **Moments editor** | **Libero** (live **v177**) | `moments.html`, `moments.js`, `moments.css`, pagine legali Moments |
...
| **`worker/worker.js`** | **Libero** (live **v165-guestbook-ingest**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
