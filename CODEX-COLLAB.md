...
| **Moments editor** | **Libero** (live **v258** — video 90 MB) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v223-video-90**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
