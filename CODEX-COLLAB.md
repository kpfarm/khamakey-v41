...
| **Moments editor** | **Libero** (live **v183**) | `moments.html`, `moments.js`, `moments.css`, pagine legali Moments |
...
| **`worker/worker.js`** | **Libero** (live **v167-guestbook-excluded**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
