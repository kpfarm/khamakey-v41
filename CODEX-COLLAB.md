...
| **Moments editor** | **Libero** (live **v264** — invito 1 editor, etichetta invitato) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v230-invite-mail** — solo HTML email invito) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
