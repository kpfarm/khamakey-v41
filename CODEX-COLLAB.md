...
| **Moments editor** | **Libero** (live **v239** — etichetta firma) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v203-signature-label**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
