...
| **Moments editor** | **Libero** (live **v178**) | `moments.html`, `moments.js`, `moments.css`, pagine legali Moments |
...
| **`worker/worker.js`** | **Libero** (live **v166-safe-guestbook-off**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
