...
| **Moments editor** | **Libero** (live **v289** — YouTube play dopo incolla; mail invito IT/EN) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v236-mail-locale**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
