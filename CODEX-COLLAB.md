...
| **`worker/worker.js`** | **Libero** (live **v149-gallery**) — file più conteso | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-20): Admin/Officina **v165** · Moments **v164** · Worker **v149-gallery** · Business shell `APP_VERSION` **167**
