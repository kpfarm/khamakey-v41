...
| **Admin / Officina Moments** | **Libero** (live **v167**) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js` — coordinarsi se stesso pannello |
...
| **`worker/worker.js`** | **Libero** (live **v156-activation-secure**) — file più conteso | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-20): Admin/Officina **v167** · Moments **v166** · Worker **v156-activation-secure** · Business shell `APP_VERSION` **167** · SQL **v160**
