...
| **Moments editor** | **Libero** (live **v237** — upload canFitBytes) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v200-upload-kind-caps**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
