...
| **Admin / Officina Moments** | **Libero** (live **v168**) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js` — coordinarsi se stesso pannello |
...
- **SSOT live** (2026-07-20): Admin/Officina **v168** · Moments **v166** · Worker **v156-activation-secure** · Business shell `APP_VERSION` **167** · SQL **v160**
