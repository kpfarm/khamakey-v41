...
| **`worker/worker.js`** | **Libero** (live **v153-gallery-contain**) — file più conteso | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-20): Admin/Officina **v165** · Moments **v164** · Worker **v152-gallery-touch** · Business shell `APP_VERSION` **167**
