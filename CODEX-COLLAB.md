...
| **Admin / Officina Moments** | **Libero** (live **v185** — PDF etichette polish) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js` — coordinarsi se stesso pannello |
