...
| **Moments editor** | **Libero** (live **v254** — copertina tutta la foto / riempi) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v219-cover-fit**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
