...
| **Moments editor** | **Libero** (live **v184**) | `moments.html`, `moments.js`, `moments.css`, pagine legali Moments |
...
| **`worker/worker.js`** | **Libero** (live **v168-horoscope**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
