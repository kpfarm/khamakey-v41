...
| **Moments editor** | **Libero** (live **v218**) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-fields.js`, `moment-horoscope.js`, `moments.css` |
...
| **`worker/worker.js`** | **Libero** (live **v185-horoscope-i18n**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
