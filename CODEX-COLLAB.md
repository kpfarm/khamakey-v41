...
| **Moments editor** | **Libero** (live **v165**) | `moments.js`, `moments.html`, `moment-*.js` — prendere lock prima di refactor ampi |
...
| **`worker/worker.js`** | **Libero** (live **v155-hero-fade**) — file più conteso | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-20): Admin/Officina **v165** · Moments **v165** · Worker **v155-hero-fade** · Business shell `APP_VERSION` **167**
