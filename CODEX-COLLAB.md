...
| **Moments editor** | **Libero** (live **v262** — assistenza via email) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v227-emoji-visible**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
