...
| **Moments editor** | **Libero** (live **v241** — HEIC lazy warm) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v206-revert-perf-css**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
