...
| **Moments editor** | **Libero** (live **v283** — niente scambi editor/anteprima tra pezzi) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
