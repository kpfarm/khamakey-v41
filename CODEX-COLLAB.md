...
| **Admin / Officina Moments** | **Libero** (live **v179**) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js` — coordinarsi se stesso pannello |
| **Moments editor** | **Libero** (live **v223** — preview locale) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Cursor 2026-07-29** — preview locale (v188) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
