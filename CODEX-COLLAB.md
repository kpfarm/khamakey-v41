...
| **Moments editor** | **Libero** (live **v226** — bootstrap categoria) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v190-public-locale**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
