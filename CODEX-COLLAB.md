...
| **Moments editor** | **Libero** (live **v211**) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moments.css` |
...
| **`worker/worker.js`** | **Libero** (live **v183-moments-i18n**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
