...
| **Admin / Officina Moments** | **Libero** (live **v192** — linee oggetto) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js` — coordinarsi se stesso pannello |
| **Moments editor** | **Libero** (live **v244** — upload foto cauto) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v212-supabase-down-guard**) — **Supabase 530/1016** | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-22): Admin/Officina **v177** · Moments **v186** · Worker **v182-hero-description** · Business shell `APP_VERSION` **168** · SQL **≥ v166**
