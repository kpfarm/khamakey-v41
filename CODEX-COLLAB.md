...
| **Moments editor** | **Libero** (live **v160**) | `moments.js`, `moments.html`, `moment-*.js` — prendere lock prima di refactor ampi |
...
- **SSOT live** (2026-07-20): Admin/Officina **v165** · Moments **v159** · Worker **v144-support-notify** · Business shell `APP_VERSION` **167**
