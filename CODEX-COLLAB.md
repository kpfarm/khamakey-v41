...
| **Moments editor** | **Libero** (live **v219**) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-fields.js`, `moment-horoscope.js`, `moments.css` |
...
| **`worker/worker.js`** | **Libero** (live **v186-storage-usage-sync**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
