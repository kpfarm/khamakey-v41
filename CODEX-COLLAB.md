...
| **Admin / Officina Moments** | **Libero** (live **v197** — codice 2 misure sullo stesso foglio) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js`, `moments-admin.css` — coordinarsi se stesso pannello |
