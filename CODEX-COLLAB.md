...
| **Admin / Officina Moments** | **Libero** (live **v194** — brand Moments) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js`, `moments-admin.css` — coordinarsi se stesso pannello |
