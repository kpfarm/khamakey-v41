...
| **Admin / Officina Moments** | **Libero** (live **v184** — PDF rettangolo codice) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js` — coordinarsi se stesso pannello |
