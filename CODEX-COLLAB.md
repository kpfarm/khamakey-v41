...
| **Moments editor** | **Libero** (live **v233** — fix salvataggi) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v196-gallery-scroll**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
