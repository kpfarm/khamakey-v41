...
| **Moments editor** | **Libero** (live **v163**) | `moments.js`, `moments.html`, `moment-*.js` — prendere lock prima di refactor ampi |
...
| **`worker/worker.js`** | **Libero** (live **v148-cover-zoom**) — file più conteso | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-20): Admin/Officina **v165** · Moments **v163** · Worker **v148-cover-zoom** · Business shell `APP_VERSION` **167**
