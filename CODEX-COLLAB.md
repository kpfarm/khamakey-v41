...
| **Moments editor** | **Libero** (live **v288** — Condividi/Share sui 4 passi) | `moments.html`, `moments.js`, `media-upload.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moment-pets.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v235-anniversary-card**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
