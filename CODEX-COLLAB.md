...
| **Moments editor** | **Libero** (live **v240** — no forced labels) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v204-no-forced-labels**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
