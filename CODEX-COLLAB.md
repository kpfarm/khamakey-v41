...
| **Moments editor** | **Libero** (live **v175**) | `moments.html`, `moments.js`, `moments.css`, pagine legali Moments |
...
| **`worker/worker.js`** | **Libero** (live **v164-guestbook**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
