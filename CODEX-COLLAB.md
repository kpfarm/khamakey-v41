...
| **Admin / Officina Moments** | **Libero** (live **v193** — etichette codice ×2 + ZIP) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js` — coordinarsi se stesso pannello |
