...
| **Moments editor** | **Libero** (live **v238** — copy video) | `moments.html`, `moments.js`, `moments-i18n*.js`, `moment-rsvp-*.js`, `moment-horoscope.js`, `moments.css`, `moment-editor-dashboard.js` |
...
| **`worker/worker.js`** | **Libero** (live **v202-lightbox-scope**) | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
