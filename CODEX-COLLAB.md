...
| **Admin / Officina Moments** | **Libero** (live **v169**) | `admin.html`, `moments-admin.html`, `admin.js`, `admin.css`, `admin-guide.js`, `admin-moment-labels.js` — coordinarsi se stesso pannello |
...
- **SSOT live** (2026-07-20): Admin/Officina **v169** · Moments **v166** · Worker **v157-nav-contrast** · Business shell `APP_VERSION` **167** · SQL **v160**
