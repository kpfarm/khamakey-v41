...
| **`worker/worker.js`** | **Libero** (live **v154-footer-contrast**) — file più conteso | Chi tocca `worker.js` prende lock esplicito e non parallelizza |
...
- **SSOT live** (2026-07-20): Admin/Officina **v165** · Moments **v164** · Worker **v154-footer-contrast** · Business shell `APP_VERSION` **167**
