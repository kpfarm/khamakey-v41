...
- **Worker v233-countdown-fit (2026-09-18)** — NFC `/m/` `/k/`
  ...
  - Editor: anteprima nel pannello allineata (Moments **v282 live**).
...
- **Moments v279 — registrazione: lead sì, hint Continua no (2026-09-17)** — **preview Pages, non produzione**
  ...
  - Worker, NFC, Salva, upload, SQL **invariati**. Live clienti resta v276.
- **Moments v278 — registrazione senza Business (2026-09-17)** — **preview Pages, non produzione**
  - Tolto il lead «non è un account Business» sotto «Nuovo account Moments». CSS `?v=268`.
  - Worker, NFC, Salva, upload, SQL **invariati**. Live clienti resta v276.
...
- **Moments v259 + Worker v224 — sogni/obiettivi: cerchi flaggabili + contrasto (2026-09-06)** — Pages + Worker
  ...
  - Testo lista/intro su card: inchiostro scuro anche con palette calda (fix `-webkit-text-fill-color`).
...
- **Moments v243 + Worker v209 — multi-pet sezione Animale (2026-08-09, Cursor)** — Pages + Worker
  ...
  - Campi legacy sincronizzati dal primo animale per compatibilità.
...
- **Admin v181 + Worker v193 — staff Moments (2026-08-03, Cursor)** — Admin + Worker + Supabase
  - `platform_members`: `khamakeymoments@gmail.com` e `spricci721@gmail.com` come admin (`admin.full`).
  - Allowlist ADMIN_EMAILS aggiornata in Officina e Worker.
...
- **Moments v210 — i18n fields Step 11e6b (2026-07-23, Cursor)** — Pages
  - Solo intro HTML pannelli Galleria / Video / Audio / Allegati sigillati; nessun tocco a upload.
- **Moments v209 — i18n fields Step 11e6a (2026-07-23, Cursor)** — Pages
  - Solo label bottoni foto sezione (`Carica foto` / `Rimuovi`); handler upload/delete invariati. 11e6 spezzato in 6a–6e.
