...
- **Email Auth Moments — template conferma (2026-08-29, Cursor)** — Ops
  - Mittente `KhamaKey Moments <noreply@khamakeymoments.com>`; testo «Attiva account» + `{{ .ConfirmationURL }}` in `docs/32-moments-auth-email.md` (incollare nel dashboard Auth).
