...
| Live | Versione | Nota |
|------|----------|------|
| Editor Moments | **v273** | Anteprima desktop ripristinata; percorso = 4 passi; Cosa puoi fare + sezioni vuote |
...
- **Controllo lacune** in corso: [[docs/33-controllo-software-lacune]] — ticket editor chiusi in tabella; guida: **v273** 4 passi come percorso, **v271** sezioni vuote, **v270** Cosa puoi fare
...
| **Email Auth Moments (conferma IT/EN)** | [`docs/32-moments-auth-email.md`](docs/32-moments-auth-email.md) · HTML [`docs/email/`](docs/email/) |
...
| **GDPR Moments (inventario + ops)** | [`docs/34-gdpr-moments.md`](docs/34-gdpr-moments.md) · registro richieste [`docs/34-gdpr-richieste.md`](docs/34-gdpr-richieste.md) |
