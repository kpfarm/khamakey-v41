...
| Live | Versione | Nota |
|------|----------|------|
| Editor Moments | **v260** | Ingresso su Pagina/Riepilogo (Come funziona) |
| Worker | **v224-dream-check** | Testo scuro sulle card; anteprima tocca il cerchio |
...
- **Controllo lacune** in corso: [[docs/33-controllo-software-lacune]] — copertina, contatore/scroll, upload video, tetto 90 MB, sogni/obiettivi e ingresso spiegazioni chiusi; altri ticket in coda
