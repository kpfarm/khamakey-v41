...
> Ultimo aggiornamento: **2026-09-18** (Worker v233 foto countdown; Moments **v282** preview ticket invitato upload; live clienti v276)
...
| **Moments editor** | **v282 preview** (live clienti ancora **v276**) | Pack grafico Dopo + fix invitato: galleria/video si salvano al primo upload, niente reload che cancella i file, errori leggibili. CSS `?v=271`. **Non** su `app.khamakeymoments.com` finché preview ok. |
...
> **Oggi 2026-09-18:** Editor live clienti **v276**. Pack grafico + ticket invitato upload **v282** in preview (non produzione). Worker **v233-countdown-fit**. SQL **v176**.  
