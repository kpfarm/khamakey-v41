...
> Ultimo aggiornamento: **2026-09-17** (Moments v279 preview copy signup; live clienti v276; Worker invariato)
...
| **Moments editor** | **v279 preview** (live clienti ancora **v276**) | Pack grafico Dopo. CSS `?v=269`. Registrazione: lead senza Business; niente hint vicino a Continua. **Non** su `app.khamakeymoments.com` finché preview ok. |
...
> **Oggi 2026-09-17:** Editor live clienti **v276**. Pack grafico **v279** in preview (non produzione). Worker **v232-support-mail** invariato · SQL **v176**.  
