...
> Ultimo aggiornamento: **2026-09-18** (Moments **v283 live**; Worker v233)
...
| **Moments editor** | **v283 live** | Cambio pezzo: editor e anteprima restano dello stesso prodotto (titolare/invitato). v282 upload invitato. Pack grafico Dopo. CSS `?v=271`. |
...
> **Oggi 2026-09-18:** Editor live **v283** su `app.khamakeymoments.com` (niente scambi editor/anteprima tra pezzi). Worker **v233-countdown-fit**. SQL **v176**.  
