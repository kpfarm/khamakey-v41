...
| **Moments editor** | **v161** | Cerchi = colore di **sfondo** (nero→pagina scura); account hub + scroll mobile. |
| **Worker NFC** | **v146-bg-palettes** | Sfondi Moments pubblici allineati ai cerchi; dark palette con testo chiaro. |
