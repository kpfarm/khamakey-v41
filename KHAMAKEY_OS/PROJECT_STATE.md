...
> Ultimo aggiornamento: **2026-09-17** (Moments v276 chrome editor; Worker invariato)
...
| **Moments editor** | **v276** | Chrome editor: Cormorant + DM Sans, icone linea, 4 passi non a card. CSS `?v=266`. |
...
> **Oggi 2026-09-17:** Editor **v276** (chrome) · Worker **v232-support-mail** invariato · SQL **v176**.  
