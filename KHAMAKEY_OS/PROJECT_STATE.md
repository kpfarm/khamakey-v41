...
| **Moments editor** | **v162** | 12 sfondi densi distinti (incluso rosso); anteprima = bl; card testo sempre nero. |
| **Worker NFC** | **v147-dense-bg** | Palette dense + `cardInk` sulle card bianche (niente testo bianco su bianco). |
