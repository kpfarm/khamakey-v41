...
> Ultimo aggiornamento: **2026-09-17** (Moments v275 guida Come si crea; Worker invariato)
...
| **Moments editor** | **v275** | Guida **Come si crea** = 4 passi (non catalogo). CSS `moments.css?v=265`. |
...
> **Oggi 2026-09-17:** Editor **v275** (Come si crea) · Worker **v232-support-mail** invariato · SQL **v176**.  
