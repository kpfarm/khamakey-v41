...
> Ultimo aggiornamento: **2026-09-18** (Moments **v282 live**; Worker v233 foto countdown)
...
| **Moments editor** | **v282 live** | Ticket invitato: galleria/video restano al primo salvataggio. Pack grafico Dopo in produzione. CSS `?v=271`. |
...
> **Oggi 2026-09-18:** Editor live **v282** su `app.khamakeymoments.com` (ticket invitato + pack grafico Dopo). Worker **v233-countdown-fit**. SQL **v176**.  
