...
### Sezioni principali
- **Ingresso editor (v280 preview / v276 / v275):** live clienti **v276**. Pack **v280** (preview): stessa logica, grafica Dopo; registrazione con codice **dentro** la confezione e Continua visibile su mobile. Il blocco in Riepilogo è la **guida ad attivare e creare** (**Come si crea**). Schede = 4 passi: Copertina, Colori, Contenuti, Pubblica. **v271:** sezioni vuote = tre passi + Non succede. **v272–v273 Officina:** anteprima desktop visibile. QR/NFC `/m/` `/k/` = pagina ospite.
