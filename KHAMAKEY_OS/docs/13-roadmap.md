...
| 2026-08-14 | Cursor Cloud | **Sync Moments live → repo**: Pages **v244** + `moment-pets` (max 6 animali); Worker backport multi-pet `v194-multi-pet` (live Cloudflare resta `v209-multi-pet` — non overwrite prod) |
