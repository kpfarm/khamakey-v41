...
| 2026-07-15 | Cursor Cloud | **Business Editor v158 hotfix**: crash sintassi `?.disabled =` in `editor.html` prod → Caricamento dati infinito; sync repo←Pages + fix; deploy Pages da fare |
