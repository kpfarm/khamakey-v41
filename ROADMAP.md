...
- [x] **Guida cliente Moments** — v270: in Riepilogo un passo (copertina/Salva) e «Cosa puoi fare» una voce alla volta (insieme, RSVP, foto…).
...
| 2026-08-03 | Cursor | **Moments v231**: assistenza = email a `info@khamakeymoments.com` (niente ticket in-app) |
...
| 2026-08-06 | Cursor | **Go-live pre-lancio**: SQL **v172** applicata su Moments + Pages **v236** deploy (`app.khamakeymoments.com`); Worker v198 già live |
...
| 2026-08-08 | Cursor | **Admin v191**: Magazzino — paginazione server-side pezzi (100/pagina, ~20k) |
...
| 2026-09-18 | Cursor | **Moments v282 preview**: invitato — galleria/video restano al primo salvataggio (auto-save, niente reload su conflitto, errori leggibili). Live clienti resta v276. Worker/SQL invariati. |
...
| 2026-09-05 | Cursor | **Moments v257 / Worker v222**: upload video — limite 50 MB visibile, niente silenzio |
...
| 2026-09-05 | Cursor | **Controllo lacune**: lista in `KHAMAKEY_OS/docs/33`; health live ok; ticket clienti in coda |
| 2026-09-04 | Cursor | **Vault OS riallineato**: `KHAMAKEY_OS/docs/13-roadmap.md` era fermo a luglio; stato, ADR-007, inventario i18n |
| 2026-09-04 | Cursor | **i18n**: «Prepara tutto» segue lingua UI (non sempre IT); etichette campi = testo cliente |
| 2026-09-04 | Cursor | **Promemoria**: P.IVA + dati societari su Privacy/Termini (IT+EN) quando ci sarà partita IVA — non inventare |
| 2026-09-04 | Cursor | **Moments v252 + Worker v218**: Privacy/Termini EN; URL italiani invariati |
...
| 2026-09-02 | Cursor | **Admin v198**: ZIP — PNG 2 misure, schede PDF codice+link, niente SVG |
| 2026-09-02 | Cursor | **Admin v197**: ZIP etichette — per pezzo codice normale + grande sullo stesso foglio (stesso N°) |
