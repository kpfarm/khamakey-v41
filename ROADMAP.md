...
- [ ] **GDPR Moments** — Fase 0 attiva (`docs/34`: niente promo, procedura Gmail). Fase 1 Privacy HTML e Fase 2 opt-in **solo con via**. Non toccare editor/NFC. Non inventare P.IVA.
